...
public class AndroidHarnessMod extends Activity implements DialogInterface.OnClickListener,
    ...
    protected String exitDialogExitY = "Yes";
    protected String exitDialogExitN = "No";
    /**
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                AlertDialog dialog = new AlertDialog.Builder(AndroidHarnessMod.this) // .setIcon(R.drawable.alert_dialog_icon)
                        .setTitle(finalTitle).setPositiveButton("Kill", AndroidHarnessMod.this).setMessage(finalMsg).create();
                dialog.show();
            }
        });
    }
    ...
    public void layoutDisplay() {
        ...
        if (layoutRes != 0) { layout = LayoutInflater.from(this).inflate(layoutRes, null); }
        ...
        if (layoutRes != 0) { frameLayout.addView(layout); }
